...
from constants import WORDS_PKL_FILE, CLASSES_PKL_FILE
...
def train_model():
    ...
    pickle.dump(words, open(WORDS_PKL_FILE, "wb"))
    pickle.dump(classes, open(CLASSES_PKL_FILE, "wb"))
